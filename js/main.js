...
const config = {
  ...
  "2021": {
    ...
    "candidates": {
      ...
      "Leonardo T. Bullaro": {color: "#72D793", displayName: "Leonardo T. Bullaro"},
      ...
      "Koshy O. Thomas": {color: "#76797E", displayName: "Koshy O. Thomas"},
      "Harpreet S. Toor": {color: "#76797E", displayName: "Harpreet S. Toor"},
      "Steve Behar": {color: "#E6CD58", displayName: "Steve Behar"},

      "Michael Hollingsworth": {color: "#EC1F27", displayName: "Michael Hollingsworth"},
      "Deirdre M. Levy": {color: "#76797E", displayName: "Deirdre M. Levy"},
      "Curtis M. Harris": {color: "#E6CD58", displayName: "Curtis M. Harris"},
      "Regina A. Kinsey": {color: "#72D793", displayName: "Regina A. Kinsey"},
      ...
      "Douglas M. Schneider": {color: "#72D793", displayName: "Douglas M. Schneider"},
      ...
      "Jessica Simmons": {color: "#76797E", displayName: "Jessica Simmons"},
      "Write-In": {color: "#76797E", displayName: "Write-In"},
    },
    "districts": {
      "CD14": { district: "CD14", headerName: "NYC Council, The Bronx, District 14", dropDownName: "CD-14 (Abreu)", file: "Member of the City Council - District 14.tsv", lastUpdated: "2021-06-23"},
      "CD22": { district: "CD22", headerName: "NYC Council, Queens, District 22", dropDownName: "CD-22 (Cabán)", file: "Member of the City Council - District 22.tsv", lastUpdated: "2021-06-23"},
      "CD23": { district: "CD23", headerName: "NYC Council, Queens, District 23", dropDownName: "CD-23 (Kaur)", file: "Member of the City Council - District 23.tsv", lastUpdated: "2021-06-23"},
      "CD35": { district: "CD35", headerName: "NYC Council, Brooklyn, District 35", dropDownName: "CD-35 (Hollingsworth)", file: "Member of the City Council - District 35.tsv", lastUpdated: "2021-06-23"},
      "CD38": { district: "CD38", headerName: "NYC Council, Brooklyn, District 38", dropDownName: "CD-38 (Avilés)", file: "Member of the City Council - District 38.tsv", lastUpdated: "2021-06-23"},
      "CD39": { district: "CD39", headerName: "NYC Council, Brooklyn, District 39", dropDownName: "CD-39 (West)", file: "Member of the City Council - District 39.tsv", lastUpdated: "2021-06-23"},
    },
    "columns": columns,
    "caption": "update2021",
  }
